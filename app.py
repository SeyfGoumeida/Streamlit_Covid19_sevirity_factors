...
if (option=="Covid19 & Severity & Asthma"):
  df = pd.read_csv("www.github.com/SeyfGoumeida/Streamlit_Covid19_sevirity_factors/tree/main/PPD%202022/Datasets/Covid19%&%Severity%&%Asthma/text_cleaned_asthma_alldf.csv") 
